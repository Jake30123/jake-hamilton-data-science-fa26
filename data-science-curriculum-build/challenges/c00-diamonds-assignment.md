...
- At every half-carat step, the price of diamonds bumps up
  significantly. There is almost a flat wall in which diamonds just
...
- Cut seems to have almost no affect on price. There are ideal diamonds
  that are the same size and cheaper than very good diamonds.
