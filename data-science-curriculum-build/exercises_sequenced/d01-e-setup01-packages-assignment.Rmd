...
Install packages downloads the packages from the cloud and saves them
locally on your machine in some directory that RStudio knows about.
Library then loads the packages to be used by the code in a given
document.
