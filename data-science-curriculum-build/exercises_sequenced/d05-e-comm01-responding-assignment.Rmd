...
*Purpose*: We're going to s

pend **a lot** of time in this class discussing datasets. To help prepare ourselves for productive discussions, we're going to use some ideas from [positive psychology](https://en.wikipedia.org/wiki/Positive_psychology) to help make our discussions more pleasant and productive.
...
- Is the bolded response **active** or **passive**? Why?
  - The response is active since it directly acknowledges the mistake, and provides a specific solution to the question.
- Is the bolded response **constructive** or **destructive**? Why?
  - The response is constructive as it both provides an answer and does so in a positive and kind manner.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  - It makes me feel smart rather than stupid for asking a solid question.
...
- Is the bolded response **active** or **passive**? Why?
  - It is passive. While the response does acknoweldge there is a problem, it neglects to provide any specific solution.
- Is the bolded response **constructive** or **destructive**? Why?
  - It is constructive since it addresses the concern with positivity.
- How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
  - It makes me feel a little confused that the person heard my concerns and just moved on.
...
- Is the bolded response **active** or **passive**? Why?
  - I think the response is passive since it is nonsequiter to the presenters previous sentence. And while related to the subject of diamonds, it derails the topic of the presentation.
- Is the bolded response **constructive** or **destructive**? Why?
  - The response is very lightly destructive as it throws the presenter off of their topic, meaning they have to change mental tack very quickly which can be annoying.
